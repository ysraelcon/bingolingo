...
function crear_room(roomx){
  ...
  if(!dv_chat_room_){
    ...
    nudiv.setAttribute("class","pos_absi top_10 lef_10 flex_col w80 h60 max_w600p bor_r bor_s al_frente")
...
if(!dv_chat_room_){
    ...
    nudiv.setAttribute("class","pos_absi top_10 lef_10 flex_col w80 h60 max_w600p bor_r bor_s")
